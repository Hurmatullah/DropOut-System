            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="{{url('report')}}" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">{{__('localize.Reports')}}</span></a>
                        </li> 
                        @admin('super')                       
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">{{__('localize.Document_Upload')}}</h3>
                </div>
                            ...
                            <div class="card-body">
                                <form action="{{url('ins_document')}}" method="POST" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="name" placeholder="{{__('localize.Enter_Name_Of_Student')}}" value="{{old('name')}}">
                                                @if($errors->has('name'))
                                            ...
                                            <div class="form-group">
                                                <input type="integer" name="dnumber" class="form-control" placeholder="{{__('localize.Enter_Document_Number')}}" value="{{old('dnumber')}}"> 
                                            ...
                                            <button type="submit" class="btn btn-info">{{__('localize.Submit')}}</button>
                                        </form>
                            </div>
                        </div>
                    </div>
