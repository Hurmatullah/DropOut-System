            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Top Kankor Students </h3>
                    </div>
                    
                    <div class="col-md-7 col-4 align-self-center">
                        <a  href = "{{url('upload')}}"  style="float: right; color: white;" class="m-b-0 m-t-0 btn btn-info">Add Students</a>
                    </div>
