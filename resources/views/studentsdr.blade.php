                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" aria-expanded="false"><i class="icon-graduation"></i><span class="hide-menu">{{__('localize.students')}}</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="{{url('black_list_dr')}}">{{__('localize.black_list')}}</a></li>
                            </ul>
                        </li>
                        <li> <a href="{{url('documents_dr')}}" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">{{__('localize.Documents')}}</span></a>
                        </li>                       
                        <li> <a href="{{url('users_dr')}}" aria-expanded="false"><i class="icon-people"></i><span class="hide-menu">{{__('localize.Users')}}</span></a>
                        </li>
                        <li> <a href="{{url('report_dr')}}" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">{{__('localize.Reports')}}</span></a>
                        </li> 
                        @admin('super')                       
                        <li> <a href="{{url('sys_logs_dr')}}" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">{{__('localize.sys_log')}}</span></a>
                        </li>
                        @endadmin
                    </ul>
                </nav>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">{{__('localize.all_students')}}</h3>
                    </div>                    
                </div>
                <!-- ============================================================== -->
                <!-- End Bread crumb and right sidebar toggle -->
                                    ...
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">{{__('localize.Action')}}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr>
                                               ...
                                               <td class="text-center">
                                                <input type="checkbox" class="check" id="minimal-checkbox-1" onchange="show(this.checked)" name="drop[]" value="{{$se->id}}">            
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                        ...
                                        <button type="submit" style="float: right; margin-right: 10px;" class="btn btn-info">{{__('localize.Drop')}}</button>
                                    </form>
                                    {{ $select->links() }}
                            </div>
                        </div>
