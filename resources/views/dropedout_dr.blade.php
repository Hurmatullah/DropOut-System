            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">{{__('localize.dropedout_students')}}</h3>
                    </div>
                </div>
                <!-- ============================================================== -->
                <!-- End Bread crumb and right sidebar toggle -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="{{url('block')}}" method="post">
                                    ...
                                    <button type="submit" style="float: right; margin-right: 10px;" class="btn btn-info">{{__('localize.Block')}}</button>
                                 </form>
                                    {{ $select->links() }}
                            </div>
                        </div>
