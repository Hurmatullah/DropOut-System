            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        @admin('super')                       
                        <li> <a href="{{url('sys_logs')}}" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">{{__('localize.sys_log')}}</span></a>
                        </li>
                        @endadmin
                    </ul>
                </nav>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">{{__('localize.Users')}}</h3>
                    </div>
                    <div class="col-md-7 col-4 align-self-center">
                        <a  href = "{{route('admin.register')}}"  style="float: left; color: white;" class="m-b-0 m-t-0 btn btn-info">{{__('localize.add_users')}}</a>
                    </div>
                </div>
                <!-- ============================================================== -->
                <!-- End Bread crumb and right sidebar toggle -->
                                    ...
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">{{__('localize.Email')}}</th>
                                                <th class="text-center">{{__('localize.Active')}}</th>
                                                <th class="text-center">{{__('localize.Created_Account')}}</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">{{$se->email}}</td>
                                                <td class="text-center">{{$se->active}}</td>
                                                <td class="text-center">{{$se->created_at}}</td>
                                                <td class="text-center"><a href="{{url('delete')}}" class="btn btn-danger">{{__('localize.Delete')}}</a></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
