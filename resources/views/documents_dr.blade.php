            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">{{__('localize.Documents')}} </h3>
                    </div>
                    <div class="col-md-7 col-4 align-self-center">
                        <a href="{{url('add_documents_dr')}}" style="float: left; color: white;" class="m-b-0 m-t-0 btn btn-info">{{__('localize.Add_Documents')}}</a>
                    </div>
                </div>
                <!-- ============================================================== -->
                <!-- End Bread crumb and right sidebar toggle -->
